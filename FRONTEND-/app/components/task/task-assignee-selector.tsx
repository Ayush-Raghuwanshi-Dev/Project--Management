...
export const TaskAssigneesSelector = ({
  ...
  const uniqueProjectMembers = projectMembers.filter(
  ...
  const handleSelectAll = () => {
    const allIds = uniqueProjectMembers.map((m) => m.user._id);
            ...
            .map((m) => (
              ...
              >
                <Avatar className="size-6 mr-1">
                  ...
                  <AvatarFallback>{(m.user.name || m.user.username || "U").charAt(0).toUpperCase()}</AvatarFallback>
                </Avatar>
              ...
              {uniqueProjectMembers.map((m) => (
                ...
                >
                  ...
                  <Avatar className="size-6 mr-2">
                    <AvatarImage src={m.user.profilePicture} />
                    <AvatarFallback>{(m.user.name || m.user.username || "U").charAt(0)}</AvatarFallback>
                  </Avatar>
